const FeatureCard = ({ header, title, description }: { header: string; title: string; description: string }) => {
  return (
    <div className="from-black-700 flex w-full rounded-xl bg-gradient-to-r to-primary-800 shadow-xl shadow-black">
      <div className="flex flex-col p-6">
        <h1 className="font-mono text-9xl font-bold text-primary-400 hover:text-tertiary-300">{header}</h1>
