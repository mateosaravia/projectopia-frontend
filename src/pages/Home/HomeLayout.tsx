...
const HomeLayout = () => {
  return (
    <div className="flex flex-col bg-gradient-to-b from-primary-950 to-primary-800">
      <div className="fixed top-0 z-10 w-full">
        <Header />
      </div>
      <div className="relative mx-auto mt-48 flex h-auto w-[80rem] flex-grow flex-col items-center justify-center space-y-40 overflow-y-auto overflow-x-hidden px-6 py-8 lg:py-0">
        ...
        <div className="flex w-full flex-col items-start justify-center overflow-visible">
          <div className="my-6 w-full border-b-2 border-primary-300">
            <h1 className="my-2 font-mono text-3xl font-bold text-primary-300">Get Started</h1>
          </div>
