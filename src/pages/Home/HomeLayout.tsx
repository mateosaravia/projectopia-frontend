...
const pageTitle = 'PROJECTOPIA';
const pageDescription = 'This is a sample project description.';
    ...
    <div className="flex flex-col justify-center">
      ...
      <div className="relative mx-auto mt-24 flex h-auto w-2/3 flex-grow flex-col items-center justify-center space-y-16 overflow-y-auto overflow-x-hidden px-1 py-8 md:mt-48 md:space-y-40 md:px-6">
        <div className="flex h-full w-full flex-col items-center justify-center">
          <h1 className="font-mono text-3xl font-bold text-tertiary-300 md:text-7xl">{pageTitle}</h1>
          <p className="font-mono text-xl text-tertiary-300">{pageDescription}</p>
        </div>
        <div className="flex w-full justify-center">
          <ProjectsCarousel projects={projects} />
        </div>
        <div className="flex w-full flex-col items-start justify-center overflow-visible">
          <div className="my-6 w-full border-b-2 border-tertiary-300">
            <h1 className="my-2 font-mono text-lg font-bold text-tertiary-300 md:text-3xl">Get Started</h1>
          </div>
